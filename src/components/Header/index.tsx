 ...
 * @LastEditTime: 2024-05-11 10:41:31
 * @Description: 头部布局
 */
...
export default function Header() {
  return (
    <header className="sticky w-screen flex gap-4 justify-between items-center top-0 h-16 shadow-md dark:shadow-white-500/50 backdrop-blur dark:bg-transparent transition-all py-3 px-4 md:px-12 lg:px-20 header-white-shadow">
      {/* 左侧 Logo 标题 */}
